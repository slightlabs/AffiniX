...
std::string_view Error::message() const noexcept {
    ...
    static constexpr std::string_view names[] = {
        "none", "full", "closed", "stopped", "expired", "not found",
        "invalid", "would block", "overflow", "bad magic",
        "unsupported version", "frame too large", "connect failed",
        "resolve failed", "no resources", "permission denied", "unsupported",
    };
